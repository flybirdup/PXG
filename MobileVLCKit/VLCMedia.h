...
/**
  * Mod funtion to the mediaWithURL, for TYKD.
  * \param anURL URL to media to be accessed
  * \param destIP NAT IP address of the client
  * \param destPort NAT port of the client
  * \param isDirect direct connet with tcp(rtsp)
  * \return A new VLCMedia object, only if there were no errors.  This object will be automatically released.
  * \see initWithMediaURLTYKD
  */
+ (instancetype)mediaWithURLTYKD:(NSURL *)anURL withDestIP:(NSString *)destIP andDestPort:(uint16_t)destPort andDirect:(BOOL)isDirect;
...
/**
  * Mod funtion to the initWithURL, for TYKD.
  * \param anURL URL to media to be accessed
  * \param destIP NAT IP address of the client
  * \param destPort NAT port of the client
  * \param isDirect direct connet with tcp(rtsp)
  * \return A new VLCMedia object, only if there were no errors.
  */
- (instancetype)initWithURLTYKD:(NSURL *)anURL withDestIP:(NSString *)destIP andDestPort:(uint16_t)destPort andDirect:(BOOL)isDirect;
